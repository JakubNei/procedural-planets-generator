...
namespace BEPUutilities
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        /// <summary>
        /// Converts a BEPUutilities.Vector4 to an OpenTK.Vector4.
        /// </summary>
        public static implicit operator OpenTK.Vector4(Vector4 bepu)
        {
            return new OpenTK.Vector4(bepu.X, bepu.Y, bepu.Z, bepu.W);
        }

        /// <summary>
        /// Converts an OpenTK.Vector4 to a BEPUutilities.Vector4.
        /// </summary>
        public static implicit operator Vector4(OpenTK.Vector4 opentk)
        {
            return new Vector4(opentk.X, opentk.Y, opentk.Z, opentk.W);
        }
