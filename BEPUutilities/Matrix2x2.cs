...
namespace BEPUutilities
{
    ...
    public struct Matrix2x2
    {
        ...
        /// <summary>
        /// Converts a BEPUutilities.Matrix2x2 to an OpenTK.Matrix2.
        /// </summary>
        public static implicit operator Matrix2(Matrix2x2 bepu)
        {
            return new Matrix2(bepu.M11, bepu.M12,
                               bepu.M21, bepu.M22);
        }

        /// <summary>
        /// Converts an OpenTK.Matrix2 to a BEPUutilities.Matrix2x2.
        /// </summary>
        public static implicit operator Matrix2x2(Matrix2 opentk)
        {
            return new Matrix2x2(opentk.M11, opentk.M12,
