...
namespace BEPUutilities
{
    ...
    public struct Matrix
    {
        ...
        /// <summary>
        /// Converts a BEPUutilities.Matrix to an OpenTK.Matrix4.
        /// </summary>
        public static implicit operator Matrix4(Matrix bepu)
        {
            return new Matrix4(bepu.M11, bepu.M12, bepu.M13, bepu.M14,
                               bepu.M21, bepu.M22, bepu.M23, bepu.M24,
                               bepu.M31, bepu.M32, bepu.M33, bepu.M34,
                               bepu.M41, bepu.M42, bepu.M43, bepu.M44);
        }

        /// <summary>
        /// Converts an OpenTK.Matrix4 to a BEPUutilities.Matrix.
        /// </summary>
        public static implicit operator Matrix(Matrix4 opentk)
        {
            return new Matrix(opentk.M11, opentk.M12, opentk.M13, opentk.M14,
                              opentk.M21, opentk.M22, opentk.M23, opentk.M24,
                              opentk.M31, opentk.M32, opentk.M33, opentk.M34,
                              opentk.M41, opentk.M42, opentk.M43, opentk.M44);
        }
