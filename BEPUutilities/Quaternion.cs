...
namespace BEPUutilities
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        /// <summary>
        /// Converts a BEPUutilities.Quaternion to an OpenTK.Quaternion.
        /// </summary>
        public static implicit operator OpenTK.Quaternion(Quaternion bepu)
        {
            return new OpenTK.Quaternion(bepu.X, bepu.Y, bepu.Z, bepu.W);
        }

        /// <summary>
        /// Converts an OpenTK.Quaternion to a BEPUutilities.Quaternion.
        /// </summary>
        public static implicit operator Quaternion(OpenTK.Quaternion opentk)
        {
            return new Quaternion(opentk.X, opentk.Y, opentk.Z, opentk.W);
        }
