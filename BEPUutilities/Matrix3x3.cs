...
namespace BEPUutilities
{
    ...
    public struct Matrix3x3
    {
        ...
        /// <summary>
        /// Converts a BEPUutilities.Matrix3x3 to an OpenTK.Matrix3.
        /// </summary>
        public static implicit operator Matrix3(Matrix3x3 bepu)
        {
            return new Matrix3(bepu.M11, bepu.M12, bepu.M13,
                               bepu.M21, bepu.M22, bepu.M23,
                               bepu.M31, bepu.M32, bepu.M33);
        }

        /// <summary>
        /// Converts an OpenTK.Matrix3 to a BEPUutilities.Matrix3x3.
        /// </summary>
        public static implicit operator Matrix3x3(Matrix3 opentk)
        {
            return new Matrix3x3(opentk.M11, opentk.M12, opentk.M13,
                                 opentk.M21, opentk.M22, opentk.M23,
                                 opentk.M31, opentk.M32, opentk.M33);
        }
