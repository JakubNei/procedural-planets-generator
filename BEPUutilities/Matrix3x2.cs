...
namespace BEPUutilities
{
    ...
    public struct Matrix3x2
    {
        ...
        /// <summary>
        /// Converts a BEPUutilities.Matrix3x2 to an OpenTK.Matrix3x2.
        /// </summary>
        public static implicit operator OpenTK.Matrix3x2(Matrix3x2 bepu)
        {
            return new OpenTK.Matrix3x2(bepu.M11, bepu.M12,
                                        bepu.M21, bepu.M22,
                                        bepu.M31, bepu.M32);
        }

        /// <summary>
        /// Converts an OpenTK.Matrix3x2 to a BEPUutilities.Matrix3x2.
        /// </summary>
        public static implicit operator Matrix3x2(OpenTK.Matrix3x2 opentk)
        {
            return new Matrix3x2(opentk.M11, opentk.M12,
                                 opentk.M21, opentk.M22,
                                 opentk.M31, opentk.M32);
        }
