...
namespace MyEngine
{
	...
	// raken from: https://referencesource.microsoft.com/#mscorlib/system/collections/generic/list.cs,cd25d0a22f9de2c7
	...
	public class UnorderedList<T> : IList<T>, IReadOnlyList<T>
	{
		...
		{
			if (capacity < 0) throw new Exception("ThrowHelper.ThrowArgumentOutOfRangeException(ExceptionArgument.capacity, ExceptionResource.ArgumentOutOfRange_NeedNonNegNum);");
		...
		public int IndexOf(T item, int index, int count)
		{
			...
			if (count < 0 || index > _size - count) throw new Exception("ThrowHelper.ThrowArgumentOutOfRangeException(ExceptionArgument.count, ExceptionResource.ArgumentOutOfRange_Count);");
			Contract.Ensures(Contract.Result<int>() >= -1);
			Contract.Ensures(Contract.Result<int>() < Count);
			Contract.EndContractBlock();
		...
		public void RemoveAt(int index)
		{
			...
			if (index < _size)
			{
				...
				// instead move last element to our position
