...
namespace MyEngine
{
	...
	public static class GeometryUtilityExtensions
	{
		public static bool Intersects(this Sphere sphere, Triangle triangle)
		{
			return GeometryUtility.Intersects(triangle, sphere);
		}
