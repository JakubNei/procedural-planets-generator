...
{
	/// <summary>
	/// Support for deffered Add, Remove and Clear to/from ICollection. Said methods are not executed until ProcessDeferredAddRemoveOrClear is called. This way you can easily modify collection during enumeration.
	/// </summary>
	public class DeferredCollection<T, T2> : ICollection<T2> where T : ICollection<T2>, new()
	{
		T underlyingCollection = new T();
		...
		public void CopyTo(T2[] array, int arrayIndex) // TODO
		{
